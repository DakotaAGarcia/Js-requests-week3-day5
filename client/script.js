...
*/ 
function createPElement(element){
...
const repeatMyParam = () => {
    //YOUR CODE HERE
axios.get(`${baseURL2}Dakota Garcia`).then(response =>{
    console.log(response.data);
...
// CODE HERE
const baseURL3 = 'http://localhost:3000/query-test';

const sendQuery = () =>{
axios.get(`${baseURL3}/'?Did this work/?Did this still work`).then(response =>{ console.log(response.data);
}).catch(error=> console.log(error));
}
